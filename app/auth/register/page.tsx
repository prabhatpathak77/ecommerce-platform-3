  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your account has been created. Welcome to Elegance!",
      })
      ...
      if (error.message.includes("already exists")) {
        setErrors((prev) => ({ ...prev, email: "Email already in use", form: "" }))
      } else {
    ...
    <div className="container mx-auto flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      <div className="grid w-full max-w-[1000px] overflow-hidden rounded-xl border shadow-lg md:grid-cols-2">
        <div className="flex flex-col justify-center bg-gradient-to-br from-violet-600 via-indigo-700 to-purple-800 p-8 text-white dark:from-violet-950 dark:via-indigo-950 dark:to-purple-950">
          <div className="mb-6">
            <h1 className="mb-2 text-3xl font-bold">Join Elegance</h1>
            <p className="text-white/80">Create an account to start shopping for beautiful accessories.</p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Track orders and save your favorites</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Get early access to sales and new arrivals</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center bg-white p-8 dark:bg-background">
          ...
          {errors.form && (
            <div className="mb-4 rounded-md bg-destructive/10 p-3 text-sm text-destructive">{errors.form}</div>
          )}
